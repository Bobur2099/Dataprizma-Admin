        ...
        >
          ...
          <thead>
            <tr class="fw-bolder text-muted">
              ...
              <th class="min-w-140px">{{ $t("email") }}</th>
              <th class="min-w-120px">{{ $t("address_uz") }}</th>
              <th class="min-w-120px">{{ $t("address_ru") }}</th>
              <th class="min-w-120px">{{ $t("address_en") }}</th>
              <th class="min-w-120px">{{ $t("phone") }}</th>
              <th class="min-w-120px">{{ $t("map_x") }}</th>
              <th class="min-w-120px">{{ $t("map_y") }}</th>
...
export default defineComponent({
  ...
  setup() {
    ...
    onMounted(() => {
      setCurrentPageBreadcrumbs(translate("company"), ["Dataprizma"]);
    });
