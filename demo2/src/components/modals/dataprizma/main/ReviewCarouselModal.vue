      ...
      <div class="modal-content">
        ...
        <div class="modal-header">
          ...
          <h2>
            ...
            ><span v-if="create == 0">Update</span> Review Carousel Main Content
          </h2>
          <!--end::Modal title-->
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
          ...
          >
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="fs-6 fw-bold form-label mb-2">Author</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="fs-6 fw-bold form-label mb-2">Position</label>
              <!--end::Label-->
...
export default defineComponent({
  ...
  methods: {
    ...
    doRequest(create, id) {
      ...
      const keys = ["file", "author", "position", "text"];

      let datas = new FormData();
      console.log(datas, typeof this.updateFile[0]);
      datas.append(keys[0], this.updateFile[0]);
      datas.append(keys[1], this.updateAuthor);
      datas.append(keys[2], this.updatePosition);
