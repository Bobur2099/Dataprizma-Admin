      ...
      <div class="modal-content">
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
          ...
          >
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Header</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Primary</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Text</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Sphere text 1</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Sphere text 2</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Sphere text 3</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Text 1</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Text 2</label>
              <!--end::Label-->
            ...
            <div class="d-flex flex-column mb-7 fv-row">
              <!--begin::Label-->
              <label class="required fs-6 fw-bold form-label mb-2">Text 3</label>
              <!--end::Label-->
...
export default defineComponent({
  ...
  methods: {
    ...
    doRequest(create, id) {
      ...
      datas.append("primary", this.updatePrimary);
      datas.append("text", this.updateText);
      datas.append("sphereText1", this.updateSphereText1);
      datas.append("sphereText2", this.updateSphereText2);
      datas.append("sphereText3", this.updateSphereText3);
      datas.append("text1", this.updateTextFirst);
      datas.append("text2", this.updateTextSecond);
      datas.append("text3", this.updateTextThird);
      if (create == 1) {
